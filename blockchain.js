...
function main() {
    ...
    // Added more transactions to increase block data size
    { from:'Tara', to: 'Paul', amount: 15 },
    { from:'Sam', to: 'Nina', amount: 90 }
    ]));
    ...
    // Added more transactions to increase block data size
    { from: 'Ivy', to: 'Jack', amount: 40 },
    { from: 'Leo', to: 'Mia', amount: 42 }
    ]));
